...
<<<<<<< HEAD
  return (
    <div className="bg-white shadow-md rounded-lg w-full overflow-hidden mx-auto">
      <img
      ...
      <div className="flex flex-row justify-between">
        <div className="p-4">
          ...
          <p className="text-gray-600 my-2">
            {ticket.eventId.description.substring(0, 100)}
          </p>
          <p className="text-sm text-gray-700 font-semibold">
            Event date: {toReadableDate(ticket.eventId.eventDate)}
          </p>
          {ticket.status === "approved" ? (
            ...
            <CodeDialog ticketId={ticket._id} />
          )}
=======
    const [isModalOpen, setIsModalOpen] = useState(false);
    const handleOpenModal = () => setIsModalOpen(true);
...
>>>>>>> 066c116563ce279a1b53dcead3ccf2f2759b383f
        </div>
        <div className="p-5 flex items-center justify-center">
          <DropdownMenu>
            <DropdownMenuTrigger>
